...
function App() {
  ...
  const app_address: number = 655558707;
  // CHANGE THIS TO YOUR APP ID
  ...
  return (
    <div className="mainContainer">
      <div className="dataContainer">
        <div className="header">🐶 Which pet would you prefer? 🐱</div>
        <div className="header2">Vote for your favorite pet!</div>
        <div className="bio"><i>Rules: Unlimited voting, get to clicking!</i></div>
              ...
              <>
                <div className="songs-container">
                  <div className="song-card">
                    <div className="title"><b>DOG 🐶</b></div>
                  ...
                  <div className="song-card">
                    <div className="title"><b>CAT 🐱</b></div>
